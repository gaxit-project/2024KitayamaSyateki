...
public class VTextEditorLayout : AbstractVTextEditorComponent
{
    ...
    private SerializedProperty _layout;                                                         // the main layout component
    private SerializedProperty _lHorizontal;
    private SerializedProperty _lMajor;
    private SerializedProperty _lMinor;
    private SerializedProperty _lSpacing;
    private SerializedProperty _gSpacing;
    private SerializedProperty _curveXZ;
    private SerializedProperty _curveXY;
    private SerializedProperty _orientXZ;
    private SerializedProperty _orientXY;
    private SerializedProperty _isCircular;
    private SerializedProperty _startAngle;
    private SerializedProperty _endAngle;
    private SerializedProperty _circleRadius;
    private SerializedProperty _animateRadius;
    ...
    private Vector2 _horizontalInfoHelpTextScrollPosition = Vector2.zero;           // the scrollview position for the horizontal help text
    private Vector2 _majorInfoHelpTextScrollPosition = Vector2.zero;                // the scrollview position for the major help text
    private Vector2 _minorInfoHelpTextScrollPosition = Vector2.zero;                // the scrollview position for the minor help text
    private Vector2 _lineSpaceInfoHelpTextScrollPosition = Vector2.zero;            // the scrollview position for the line space help text
    private Vector2 _glyphSpaceInfoHelpTextScrollPosition = Vector2.zero;           // the scrollview position for the glyph space help text
    private Vector2 _curveBendingXZInfoHelpTextScrollPosition = Vector2.zero;       // the scrollview position for the curve bending (XZ) help text
    private Vector2 _curveBendingXYInfoHelpTextScrollPosition = Vector2.zero;       // the scrollview position for the curve bending (XY) help text
    private Vector2 _circularBendingInfoHelpTextScrollPosition = Vector2.zero;      // the scrollview position for the circular help text
    ...
    public VTextEditorLayout(SerializedObject obj, UnityEditor.Editor currentEditor)
    {
        _layout = obj.FindProperty("LayoutParameter");

        _lHorizontal = _layout.FindPropertyRelative("_isHorizontal");
        _lMajor = _layout.FindPropertyRelative("_major");
        _lMinor = _layout.FindPropertyRelative("_minor");

        _lSpacing = _layout.FindPropertyRelative("_spacing");
        _gSpacing = _layout.FindPropertyRelative("_glyphSpacing");
        _curveXZ = _layout.FindPropertyRelative("_curveXZ");
        _curveXY = _layout.FindPropertyRelative("_curveXY");
        _orientXZ = _layout.FindPropertyRelative("_orientXZ");
        _orientXY = _layout.FindPropertyRelative("_orientXY");

        _isCircular = _layout.FindPropertyRelative("_isCircular");
        _startAngle = _layout.FindPropertyRelative("_startRadius");
        _endAngle = _layout.FindPropertyRelative("_endRadius");
        _circleRadius = _layout.FindPropertyRelative("_circleRadius");
        _animateRadius = _layout.FindPropertyRelative("_animateRadius");
        _radiusCurve = _layout.FindPropertyRelative("_curveRadius");
    ...
    private bool DrawCommonParameters()
    {
        ...
        int nMajor = (int)(Align)EditorGUILayout.EnumPopup(new GUIContent("Major:", "Major layout mode"),
            (Align)System.Enum.GetValues(typeof(Align)).GetValue(_lMajor.enumValueIndex));
        ...
        int nMinor = (int)(Align)EditorGUILayout.EnumPopup(new GUIContent("Minor:", "Minor layout mode"),
            (Align)System.Enum.GetValues(typeof(Align)).GetValue(_lMinor.enumValueIndex));
