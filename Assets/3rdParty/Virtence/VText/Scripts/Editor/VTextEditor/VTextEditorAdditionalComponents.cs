...
public class VTextEditorAdditionalComponents : AbstractVTextEditorComponent
{
    ...
    private SerializedProperty _additionalComponentsSection;                                        // the section of the vtext object which holds the additional components
    private SerializedProperty _referenceObjects;                                                   // the objects which holds the additional components
    ...
    public VTextEditorAdditionalComponents(SerializedObject obj, UnityEditor.Editor currentEditor)
    {
