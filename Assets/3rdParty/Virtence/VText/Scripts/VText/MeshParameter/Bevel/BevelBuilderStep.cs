...
namespace Virtence.VText
{
	...
	internal class BevelBuilderStep : BevelBuilderStrategy
	{
        ...
        internal BevelBuilderStep(VTextMeshParameter meshParameter) : base(meshParameter)
        {
        }
        ...
        internal override void AddBevelBackfacesToMesh(ref MeshAttributes meshAttribs)
        {
            ...
            for (int j = 0; j < meshAttribs.VertexAttributes.Count; ++j)
            {
                ...
                {
                    // add verts
                    meshAttribs.Verticies.Add(attr.VertexPosition + Vector3.forward * (_meshParameter.Bevel * 2.0f + _meshParameter.Depth));
                    meshAttribs.Verticies.Add(attr.VertexPosition + Vector3.forward * (_meshParameter.Bevel + _meshParameter.Depth));
                    ...
                    meshAttribs.UVs.Add(new Vector3(_meshParameter.Bevel, attr.VDistanceBevel));
                }
            ...
            Vector3 backfaceOffset = Vector3.forward * (_meshParameter.Bevel + _meshParameter.Depth);
            ...
            for (int j = 0; j < meshAttribs.VertexAttributes.Count; ++j)
            {
                ...
                foreach (var attr in meshAttribs.VertexAttributes[j])
                {
                    ...
                    // add uvs
                    meshAttribs.UVs.Add(new Vector3(_meshParameter.Bevel, attr.VDistanceContour));
                    meshAttribs.UVs.Add(new Vector3(_meshParameter.Bevel + _meshParameter.Bevel, attr.VDistanceBevel));
                }
        ...
        internal override void AddBevelFrontFacesToMesh(ref MeshAttributes meshAttribs)
        {
            ...
            for (int j = 0; j < meshAttribs.VertexAttributes.Count; ++j)
            {
                ...
                foreach (var attr in meshAttribs.VertexAttributes[j])
                {
                    ...
                    meshAttribs.Verticies.Add(attr.VertexPosition + Vector3.forward * _meshParameter.Bevel);
            ...
            for (int j = 0; j < meshAttribs.VertexAttributes.Count; ++j)
            {
                ...
                foreach (var attr in meshAttribs.VertexAttributes[j])
                {
                    ...
                    if (_meshParameter.UseFaceUVs)
                    {
                        // face uvs
                        meshAttribs.UVs.Add(attr.VertexPosition);
                        meshAttribs.UVs.Add(attr.BevelVertexDirection);
                    }
                    else
                    {
                        // side uvs
                        meshAttribs.UVs.Add(new Vector3(_meshParameter.Bevel, attr.VDistanceContour));
                        meshAttribs.UVs.Add(new Vector3(_meshParameter.Bevel*2f, attr.VDistanceBevel));
                    }
                }
