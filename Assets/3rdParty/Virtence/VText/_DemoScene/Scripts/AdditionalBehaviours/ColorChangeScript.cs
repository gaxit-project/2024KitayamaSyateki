	    ...
	    private IEnumerator ChangeColor() {
	        while (true) {
                ...
                if (_meshRenderer.materials != null) {
                    if (_meshRenderer.materials.Length > (int)GlyphParts.FrontFace)
                    {
                        _meshRenderer.materials[(int)GlyphParts.FrontFace].color = c;
                    }

                    c = new Color(Random.Range(0.0f, 1.0f), Random.Range(0.0f, 1.0f), Random.Range(0.0f, 1.0f), 1.0f);
                    if (_meshRenderer.materials.Length > (int)GlyphParts.Bevel)
                    {
                        _meshRenderer.materials[(int)GlyphParts.Bevel].color = c;
                    }

                    c = new Color(Random.Range(0.0f, 1.0f), Random.Range(0.0f, 1.0f), Random.Range(0.0f, 1.0f), 1.0f);
                    if (_meshRenderer.materials.Length > (int)GlyphParts.Side)
                    {
                        _meshRenderer.materials[(int)GlyphParts.Side].color = c;
                    }
                }
