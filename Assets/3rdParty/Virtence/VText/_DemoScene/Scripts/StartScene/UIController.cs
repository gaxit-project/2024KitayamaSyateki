...
namespace Virtence.VText.Demo {
	...
	{	
	    ...
	    public void SetMajorLayoutLeft(bool enabled) {
	        if (enabled) {
	            VTextController.SetAlignment(Align.Start);
	        }
	    } 
	    ...
	    public void SetMajorLayoutCenter(bool enabled) {
	        if (enabled) {
	            VTextController.SetAlignment(Align.Center);
	        }
	    } 
	    ...
	    public void SetMajorLayoutRight(bool enabled) {
	        if (enabled) {
	            VTextController.SetAlignment(Align.End);
	        }
	    } 
	    ...
	    public void SetMajorLayoutBlock(bool enabled) {
	        if (enabled) {
	            VTextController.SetAlignment(Align.Justified);
	        }
	    } 
	    ...
	    public void EnableLightProbes(bool enable) {
	        VTextController.SetLightProbes(enable ? LightProbeUsage.BlendProbes : LightProbeUsage.Off);
	    }
		#endregion // METHODS
